...
stls.borderRadius({ pass: { arrayValue: [jsvals.j8({pass: {
      ...
      componentSvg: (Svg:any, SvgObj:any) => {
        const { Defs, Stop, Path, LinearGradient, G, Circle, Rect, Mask } = SvgObj;
        return (props:any) => (<Svg xmlns=http://www.w3.org/2000/svg     width={14}     height={14}     fill=red     viewBox=0 0 14 14     {...props}   >     <Path       stroke=#000001       strokeLinecap=round       strokeLinejoin=round       d=M.5 7 7 .5 13.5 7m-11 1.5v5h9v-5     />   </Svg>)
      },

      svgOriginal: `
        <svg width=14 height=14 viewBox=0 0 14 1 fill=none xmlns=http://www.w3.org/2000/svg> <path d=M0.5 7L7 0.5L13.5 7M2.5 8.5V13.5H11.5V8.5 stroke=#000001 stroke-linecap=round stroke-linejoin=round/> </svg>
      `,
